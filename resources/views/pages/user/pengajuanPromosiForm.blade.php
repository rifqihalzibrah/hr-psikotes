    ...
    <form class="card mb-4" action="{{ @$action_route }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="date" name="tanggal_lahir" id="tanggal_lahir"
                        value="{{ $data_pengajuan->tanggal_lahir ?? '' }}">
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="pendidikan" id="pendidikan"
                        value="{{ $data_pengajuan->pendidikan ?? '' }}">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="unit_divisi" id="unit_divisi"
                        value="{{ $data_pengajuan->unit_divisi ?? '' }}">
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="departemen" id="departemen"
                        value="{{ $data_pengajuan->departemen ?? '' }}">
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="date" name="tanggal_join" id="tanggal_join"
                        value="{{ $data_pengajuan->tanggal_join ?? '' }}">
                </div>
            </div>
            <div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="jabatan_saat_ini" id="jabatan_saat_ini"
                        value="{{ $data_pengajuan->jabatan_saat_ini ?? '' }}">
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="jabatan_tujuan" id="jabatan_tujuan"
                        value="{{ $data_pengajuan->jabatan_tujuan ?? '' }}">
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="golongan_saat_ini" id="golongan_saat_ini"
                        value="{{ $data_pengajuan->golongan_saat_ini ?? '' }}">
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="golongan_tujuan" id="golongan_tujuan"
                        value="{{ $data_pengajuan->golongan_tujuan ?? '' }}">
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" name="gaji_saat_ini" id="gaji_saat_ini"
                        value="{{ $data_pengajuan->gaji_saat_ini ?? '' }}">
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" name="gaji_tujuan" id="gaji_tujuan"
                        value="{{ $data_pengajuan->gaji_tujuan ?? '' }}">
                </div>
            </div>
            <div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="alasan_promosi" name="alasan_promosi" rows="3">{{ $data_pengajuan->alasan_promosi ?? '' }}</textarea>
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="evaluasi_atasan">Evaluasi atasan</label>
                <div class="col-sm-10">
                    <textarea class="form-control" id="evaluasi_atasan" name="evaluasi_atasan" rows="3">{{ $data_pengajuan->evaluasi_atasan ?? '' }}</textarea>
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="rewards_prestasi">Rewards/prestasi</label>
                <div class="col-sm-10">
                    <textarea class="form-control" id="rewards_prestasi" name="rewards_prestasi" rows="3">{{ $data_pengajuan->rewards_prestasi ?? '' }}</textarea>
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="punishment_sanksi">Punishment/sanksi</label>
                <div class="col-sm-10">
                    <textarea class="form-control" id="punishment_sanksi" name="punishment_sanksi" rows="3">{{ $data_pengajuan->punishment_sanksi ?? '' }}</textarea>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10 d-flex">
                    <input type="text" class="form-control me-2" name="riwayat_performance_tahun_pertama"
                        ...
                        value="{{ $data_pengajuan->riwayat_performance_tahun_pertama ?? '' }}">
                    <input type="text" class="form-control me-2" name="riwayat_performance_tahun_kedua"
                        ...
                        value="{{ $data_pengajuan->riwayat_performance_tahun_kedua ?? '' }}">
                    <input type="text" class="form-control" name="riwayat_performance_tahun_ketiga"
                        ...
                        value="{{ $data_pengajuan->riwayat_performance_tahun_ketiga ?? '' }}">
                </div>
            </div>
            <div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10 d-flex">
                    <select class="form-select" aria-label="Default select example" name="user_pengusul">
                        @if ($data_pengajuan)
                            <option value="0" {{ $data_pengajuan->user_pengusul == 0 ? 'selected' : '' }}>Tidak
                                Setuju</option>
                            <option value="1" {{ $data_pengajuan->user_pengusul == 1 ? 'selected' : '' }}>Setuju
                            </option>
                        @else
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10 d-flex">
                    <select class="form-select" aria-label="Default select example" name="atasan_pengusul">
                        @if ($data_pengajuan)
                            <option value="0" {{ $data_pengajuan->atasan_pengusul == 0 ? 'selected' : '' }}>Tidak
                                Setuju</option>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10 d-flex">
                    <select class="form-select" aria-label="Default select example" name="direktur_unit">
                        @if ($data_pengajuan)
                            <option value="0" {{ $data_pengajuan->direktur_unit == 0 ? 'selected' : '' }}>Tidak
                                Setuju</option>
                            <option value="1" {{ $data_pengajuan->direktur_unit == 1 ? 'selected' : '' }}>Setuju
                            </option>
                        @else
                            <option value="0">Tidak Setuju</option>
                            <option value="1">Setuju</option>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10 d-flex">
                    <select class="form-select" aria-label="Default select example" name="hrd">
                        @if ($data_pengajuan)
                            <option value="0" {{ $data_pengajuan->hrd == 0 ? 'selected' : '' }}>Tidak
                                Setuju</option>
                            <option value="1" {{ $data_pengajuan->hrd == 1 ? 'selected' : '' }}>Setuju
                            </option>
                        @else
                            <option value="0">Tidak Setuju</option>
                            <option value="1">Setuju</option>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10 d-flex">
                    <select class="form-select" aria-label="Default select example" name="pm">
                        @if ($data_pengajuan)
                            <option value="0" {{ $data_pengajuan->pm == 0 ? 'selected' : '' }}>Tidak
                                Setuju</option>
                            <option value="1" {{ $data_pengajuan->pm == 1 ? 'selected' : '' }}>Setuju
                            </option>
                        @else
                            <option value="0">Tidak Setuju</option>
                            <option value="1">Setuju</option>
